...
OnItemClickListener {
    ...
    private List<Lost> newsList = new ArrayList<Lost>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lost);
		 ...
		 btnlost=(Button)findViewById(R.id.but);
		 btnlost.setOnClickListener(new OnClickListener(){
	        	@Override
	            public void onClick(View v){
	        		Intent intent=new Intent();
	        		intent.setClass(LostActivity.this,MessageActivity.class);
        ...
        // 新闻
        LostListAdapter = new com.example.ldu.adapter.LostListAdapter(this, newsList);
        lvNewsList.setAdapter(LostListAdapter);
    ...
    public void getNewsData() {
        ...
        query.findObjects(this, new FindListener<Lost>() {
            ...
            public void onSuccess(List<Lost> object) {
                newsList = object;
                // 通知Adapter数据更新
                LostListAdapter.refresh((ArrayList<Lost>) newsList);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
            long id) {
        Intent toNewsDetail = new Intent(LostActivity.this, NewsActivity.class);
